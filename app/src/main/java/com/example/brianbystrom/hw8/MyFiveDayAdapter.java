    ...
    public void onBindViewHolder(MyFiveDayAdapter.ViewHolder holder, final int position) {
        ...
        holder.iv_five.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                minTV.setText("Min Temp: " + ((CityWeather) mContext).tempConverter(mDataset.get(position).getMin()));
                maxTV.setText("Max Temp: " + ((CityWeather) mContext).tempConverter(mDataset.get(position).getMax()));
